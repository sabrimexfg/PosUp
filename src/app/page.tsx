...
export default function HomePage() {
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="pt-40 pb-24 px-6 text-center bg-gradient-to-br from-[#FEF3C7] to-[#FDE68A] relative overflow-hidden">
      ...
      {/* Trust Banner */}
      <section className="bg-[#3D2314] py-6">
        <div className="flex justify-center gap-10 flex-wrap max-w-[1200px] mx-auto px-6">
          <div className="flex items-center gap-3 font-medium text-[#FEF3C7]">
      ...
      <section id="about" className="bg-white py-24 px-6">
        <div className="max-w-[740px] mx-auto">
          ...
          <div className="text-center">
            <p className="text-[17px] text-[#5C3A2A] leading-relaxed">
      ...
      {/* Technology Bridge */}
      <section className="bg-[#3D2314] text-white py-24 px-6 overflow-hidden">
        <div className="max-w-[1200px] mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-14">
            <div className="flex-1 min-w-[300px]">
              ...
              <h2 className="text-3xl md:text-[42px] font-bold text-[#FEF3C7] mb-6 leading-tight">
              ...
              <p className="text-lg text-[#D4A574] mb-8">
                ...
                <strong className="text-[#FEF3C7]">PosUp</strong> is the result of
                years of on-the-ground experience—coming soon.
              </p>
              <ul className="space-y-4 mb-10">
                <li className="relative pl-7 text-lg text-[#FEF3C7]">
                  <span className="absolute left-0 text-[#E85D04]">→</span>
            ...
            <div className="flex-1 flex justify-center min-w-[300px]">
              <Image
                ...
                width={200}
                height={200}
                className="rounded-[40px] shadow-[0_20px_50px_rgba(232,93,4,0.4)]"
              />
            </div>
          </div>
        </div>
