...
const firebaseConfig = {
    apiKey: ("TURBOPACK compile-time value", "AIzaSyD83Hko0wLBhi2JDVwEw75UM--IGnixsaY"),
    authDomain: ("TURBOPACK compile-time value", "posup-ba5be.firebaseapp.com"),
    projectId: ("TURBOPACK compile-time value", "posup-ba5be"),
    storageBucket: ("TURBOPACK compile-time value", "posup-ba5be.firebasestorage.app"),
    messagingSenderId: ("TURBOPACK compile-time value", "659640233256"),
    appId: ("TURBOPACK compile-time value", "1:659640233256:web:6ee1ab489b509b9bc2341d"),
    measurementId: ("TURBOPACK compile-time value", "G-6FRTDTPZWP")
};
// Initialize Firebase
...
let db;
try {
    db = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initializeFirestore"])(app, {
...
function Dashboard() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Dashboard.useEffect": ()=>{
            let unsubscribeBusiness = {
                "Dashboard.useEffect.unsubscribeBusiness": ()=>{}
            }["Dashboard.useEffect.unsubscribeBusiness"];
            let unsubscribeItems = {
                "Dashboard.useEffect.unsubscribeItems": ()=>{}
            }["Dashboard.useEffect.unsubscribeItems"];
            let unsubscribeCustomers = {
                "Dashboard.useEffect.unsubscribeCustomers": ()=>{}
            }["Dashboard.useEffect.unsubscribeCustomers"];
            const unsubscribeAuth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onAuthStateChanged"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["auth"], {
                "Dashboard.useEffect.unsubscribeAuth": (currentUser)=>{
                    setUser(currentUser);
                    setLoading(false); // Set loading to false once auth state is known
                    if (currentUser) {
                        // 1. Subscribe to Business Info
                        const userDocRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"], "users", currentUser.uid);
                        unsubscribeBusiness = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(userDocRef, {
                            "Dashboard.useEffect.unsubscribeAuth": (docSnap)=>{
                                ...
                                setStats({
                                    "Dashboard.useEffect.unsubscribeAuth": (prev)=>({
                                            ...prev,
                                            businessName,
                                            source
                                        })
                                }["Dashboard.useEffect.unsubscribeAuth"]);
                            }
                        }["Dashboard.useEffect.unsubscribeAuth"]);
                        // 2. Subscribe to Item Count
                        const itemsColRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"], `users/${currentUser.uid}/items`);
                        unsubscribeItems = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(itemsColRef, {
                            "Dashboard.useEffect.unsubscribeAuth": (snapshot)=>{
                        ...
                        const customersColRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"], `users/${currentUser.uid}/customers`);
                        unsubscribeCustomers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(customersColRef, {
                            "Dashboard.useEffect.unsubscribeAuth": (snapshot)=>{
                                const source = snapshot.metadata.fromCache ? "Cache ⚡️" : "Live 🟢";
                                setStats({
                                    "Dashboard.useEffect.unsubscribeAuth": (prev)=>({
    ...
    const handleLogin = async ()=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signInWithPopup"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["auth"], __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["provider"]);
        } catch (error) {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "flex items-center justify-between mx-auto max-w-6xl",
                    children: [
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "flex items-center gap-2 text-sm bg-white px-3 py-1 rounded-full border shadow-sm",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: `font-semibold ${stats.source.includes("Cache") ? "text-orange-500" : "text-green-600"}`,
...
_s(Dashboard, "4Xj6U0lU8b9EA79T+Xv0IB40xB0=", false, function() {
    return [
...
//# sourceMappingURL=src_91431522._.js.map